        ...
        <div className='container'>
            ...
            <div className='tab-style'>
                ...
                <div class="tab-content tab-content-style" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0"><div class=' d-flex justify-content-center align-items-center'><Upload /></div></div>
                    <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0"><div class=' d-flex justify-content-center align-items-center'><Upload /></div></div>
                </div>
            </div>
        </div>
    )
